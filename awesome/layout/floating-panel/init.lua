...
local floating_panel = function(s)
	...
	awful.placement.right(panel, {margins = {
		right = panel_margins,
	...
	open_panel = function()
		...
		if panel.mode == 'today_mode' then
			awful.placement.right(panel, {margins = {
				right = panel_margins,
				top = s.geometry.height - dpi(1020)
				}, parent = s
			})
		else
			awful.placement.right(panel, {margins = {
				right = panel_margins,
				top = s.geometry.height - dpi(300)
				}, parent = s
			})
		end
