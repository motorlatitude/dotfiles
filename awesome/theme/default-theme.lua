...
-- Menu icon theme
theme.icon_theme = 'McMuse-yellow-dark'
...
local awesome_overrides = function(theme)
	...
	theme.wallpaper = '/home/lenny/Pictures/Wallpapers/scifi.jpg'
	...
	theme.titlebar_bg_focus = beautiful.gtk.get_theme_variables().bg_color:sub(1,7) .. '88'
	theme.titlebar_bg_normal = beautiful.gtk.get_theme_variables().base_color:sub(1,7) .. '88'
