...
client.connect_signal("request::titlebars", function(c)
	...
	if c.class == 'dolphin' or c.class == 'pavucontrol-qt' or 
	...
	elseif c.class == 'firefox' or c.class == 'firefoxdeveloperedition' then
		decorate_titlebar(c, 'top', '#202124ff', titlebar_size)
